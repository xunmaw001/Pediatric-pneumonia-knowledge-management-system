...
public class JinridongtaiView extends JinridongtaiEntity implements Serializable {
	...
	public JinridongtaiView() {

	}

	public JinridongtaiView(JinridongtaiEntity jinridongtaiEntity) {
		try {
			BeanUtils.copyProperties(this, jinridongtaiEntity);

...
var indexNav = [
    ...
    {
        name: '肺炎知识',
        url: './pages/feiyanzhishi/list.html'
    },
    {
        name: '今日动态',
        url: './pages/jinridongtai/list.html'
    },
    {
        name: '通知',
...
var adminurl =  "http://localhost:8080/xiaoerfeiyanzhishi/admin/dist/index.html#/login";
